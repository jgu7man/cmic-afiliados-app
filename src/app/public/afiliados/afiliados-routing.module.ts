...
const routes: Routes = [
  {
    ...
    children: [
      ...
      { path: '', component: AfiliadosAdminComponent, children:[
        ...
        { path: 'experiencia/:RFC', component: AfiliadosExperienciaComponent, data:{title: 'Experiencia'}, },
        { path: 'capacidad-contable/:RFC', component: AfiliadosCapacidadContableComponent,data:{title: 'Capacidad contable'}, },
        { path: 'equipo-maquinaria/:RFC', component: AfiliadosEquipoMaquinariaComponent, data:{title: 'Equipo y maquinaria'}, },
        { path: 'recursos-humanos/:RFC', component: AfiliadosRecursosHumanosComponent, data:{title: 'Recursos humanos'}, },
        { path: 'certificaciones-especializaciones/:RFC', component: AfiliadosCertificacionesEspecializacionesComponent, data:{title: 'Certificados y especializaciones'}, },
